/**
 * Canonical types for Arrival MVP.
 *
 * This is the source of truth for all type definitions.
 * Derived from 09-event-and-api-spec.md, 03-proof-spec.md, and 02-architecture.md.
 */

import type { RejectCode } from './constants.js'

// Re-export RejectCode so consumers can get types from one place
export type { RejectCode } from './constants.js'
